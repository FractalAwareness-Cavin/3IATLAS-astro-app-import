...
Files by platform
-----------------
- `KStars_Append_3I.command` — macOS helper (runs the shell backend and auto-detects the Application Support path).
- `KStars_Append_3I.sh` — Linux helper.
- `KStars_Append_3I-DRYRUN.bat` / `KStars_Append_3I-APPLY.bat` — Windows preview/apply wrappers.
- `KStars_Append_3I.ps1` — Windows PowerShell backend used by both batch files.
